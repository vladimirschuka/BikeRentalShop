...
SELECT pg_catalog.setval('main_sequence', 17708, true);
...
COPY t_prices_specials_conditions (id, price_plan_id, beg_date_order, end_date_order, period_beg_date, period_end_date, bike_model_id, customer_group_id, bike_count, period_order_in_hour, val_id, prct_flag, price_specials_value, created_at, updated_at, holiday_flag) FROM stdin;
\.
